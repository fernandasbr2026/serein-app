...
function htmlPIG(p) {
  ...
  s += '<h2>Perfil / Condiciones</h2><table class="d"><tbody><tr><td>Limpieza SSPC-SP</td><td>' + (p.limpiezaSSPC || '') + '</td><td>Perfil solicitado</td><td>' + (p.perfilSolicitado || '') + '</td></tr><tr><td>Medidas</td><td>' + (p.medidas || []).join(' - ') + '</td><td>Perfil obtenido</td><td>' + (p.perfilObtenido || promTxt) + '</td></tr></tbody></table>'
