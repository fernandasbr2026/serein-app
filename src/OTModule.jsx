...
function ProtoPGPForm({ p, upd, onDel, instrumentos, marcasEsperadas = [], usadasEnOtros = [] }) {
  const ip = { padding: '6px 8px', border: '1px solid #DFE4EA', fontSize: 12.5, boxSizing: 'border-box', width: '100%' }
