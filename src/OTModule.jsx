...
function descargarProto(p, equipos) { const w = window.open('', '_blank'); if (!w) { window.alert('Habilita las ventanas emergentes.'); return } w.document.write(p.tipo === 'PIG' ? htmlPIG(p, equipos) : htmlPGP(p, equipos)); w.document.close(); setTimeout(function () { w.focus(); w.print() }, 400) }
...
function ProtoHead({ p, upd, onDel, titulo, equipos }) {
